package com.endeavour.tap4food.user.app.controller.exception;
...
import com.endeavour.tap4food.user.app.controller.AuthController;
import com.endeavour.tap4food.user.app.controller.CustomerController;

@ControllerAdvice(basePackageClasses = { AuthController.class, CustomerController.class })
